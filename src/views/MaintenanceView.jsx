      ...
      <div className="maintenance-card-container">
        ...
        <div className="maint-graphic-box">
          ...
          <div className="maint-icon-square">
            {/* Server SVG */}
            <svg className="maint-server-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            {/* Spinning Gear SVG */}
            <svg className="maint-gear-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div className="maint-footer-bar">
          <span>TTS Finance SaaS &bull; System Monitoring</span>
